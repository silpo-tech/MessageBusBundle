...
namespace MessageBusBundle\Tests\TestCase\Command;

use Interop\Queue\Context;
use MessageBusBundle\Command\RequeueFailedCommand;
use MessageBusBundle\Producer\ProducerInterface;
use MessageBusBundle\Tests\DataProvider\MessageGenerator;
...
class RequeueFailedCommandTest extends KernelTestCase
{
    ...
    {
        [$data, $conditions, $expected] = $this->resolveValues($data, $conditions, $expected);
    ...
    private static function publishToFailedQueue(int $messagesQty): array
    {
        ...
        $messages = MessageGenerator::generateMessages($messagesQty);
